...
6) Keep the `explanation` clear and concise, with a length of roughly {MC_QUESTION_EXPLANATION_MAX_CHARS} characters or fewer unless more detail is absolutely required."""
...
USER_PROMPT = (
    ...
    f"Keep each `explanation` clear and concise, with a length of roughly {MC_QUESTION_EXPLANATION_MAX_CHARS} characters or fewer unless more detail is absolutely required.\n\n"
