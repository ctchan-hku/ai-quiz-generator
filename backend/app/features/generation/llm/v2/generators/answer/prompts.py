from app.features.generation.config.mc_question import (
    MC_QUESTION_EXPLANATION_TARGET_CHARS,
)
...
6) Keep the `explanation` clear and concise—aim for roughly {MC_QUESTION_EXPLANATION_TARGET_CHARS} characters."""
...
USER_PROMPT = (
    ...
    f"Keep each `explanation` clear and concise—aim for roughly {MC_QUESTION_EXPLANATION_TARGET_CHARS} characters.\n\n"
