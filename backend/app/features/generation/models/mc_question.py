...
import app.features.generation.config.mc_question
...
from app.features.generation.helpers.options import truncate_options
...
class MultipleChoiceQuestion(BaseModel):
    ...
    guardrails: ClassVar[str] = app.features.generation.config.mc_question.GUARDRAILS
    chain_of_thought: ClassVar[str] = (
        app.features.generation.config.mc_question.CHAIN_OF_THOUGHT
    )
