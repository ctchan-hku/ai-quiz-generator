...
CHAIN_OF_THOUGHT = f"""Work like an expert solver:
...
6) Keep the `explanation` clear and concise, with a length of roughly {MC_QUESTION_EXPLANATION_SOFT_MAX_CHARS} characters or fewer unless more detail is absolutely required."""
...
USER_PROMPT = (
    ...
    f"Keep each `explanation` clear and concise, with a length of roughly {MC_QUESTION_EXPLANATION_SOFT_MAX_CHARS} characters or fewer unless more detail is absolutely required.\n\n"
