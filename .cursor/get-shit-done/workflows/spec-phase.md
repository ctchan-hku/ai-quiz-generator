...
```bash
INIT=$(node "C:/Users/noahc/Documents/projects/talic/cetl-gear/.cursor/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/noahc/Documents/projects/talic/cetl-gear/.cursor/get-shit-done/templates/spec.md.
