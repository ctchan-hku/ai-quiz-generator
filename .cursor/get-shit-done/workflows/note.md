...
- **Global scope**: `C:/Users/noahc/Documents/projects/talic/cetl-gear/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/noahc/Documents/projects/talic/cetl-gear/.cursor/notes/`)
...
2. Glob `C:/Users/noahc/Documents/projects/talic/cetl-gear/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/noahc/Documents/projects/talic/cetl-gear/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/noahc/Documents/projects/talic/cetl-gear/.cursor/notes/` — works in any directory
