...
```bash
node "C:/Users/noahc/Documents/projects/talic/cetl-gear/.cursor/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `C:/Users/noahc/Documents/projects/talic/cetl-gear/.cursor/get-shit-done/templates/retrospective.md`.
