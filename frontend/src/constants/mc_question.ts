...
export const MC_QUESTION_OPTION_COUNT_DEFAULT = 4
export const MC_QUESTION_CORRECT_INDICES_MIN_COUNT = 1
export const MC_QUESTION_EXPLANATION_SOFT_MAX_CHARS = 1000
