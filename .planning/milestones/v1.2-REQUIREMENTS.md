# Requirements Archive: v1.2 Model board & generation cost visibility

**Archived:** 2026-05-05
**Status:** SHIPPED

For the **next** milestone, create a fresh `.planning/REQUIREMENTS.md` via **`/gsd-new-milestone`** (this archive is the v1.2 contract only).
